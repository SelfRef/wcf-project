...
namespace WPFClient.Model
{
  ...
  public class Connection : IConnection
  {
    ...
    public void SendPosition(List<PositionData> position)
    {
      try
      {
    ...
    public void CreateBullet(PositionData position)
    {
      try
      {
        Channel.CreateBullet(JsonConvert.SerializeObject(position));
      }
      catch (Exception e)
      {
        MessageBox.Show(e.Message);
